...
function Hero() {
  return (
    ...
    <div className="h-screen flex flex-col bg-gradient-to-r from-[#002865] to-[#004EC3]  relative overflow-hidden">
      ...
      <div className="text-center mx-auto md:mt-[200px] mt-[200px] z-10">
      ...
      <div className="absolute block z-20 md:left-[390px] md:top-[200px] top-[200px] left-[15px]">
        <img className="md:h-70 md:w-45 h-[40px]" alt="Glow mark" src="images/glow-mark.svg" />
      </div>
      
      <div className="absolute block md:h-[625px] h-[650px] w-full max-w-full md:top-[201px] top-[200px]">
